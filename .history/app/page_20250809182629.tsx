...
// Import your UI components here (or create them)
...
// Optional: use this FeatureCard component somewhere else or remove it if unused
function FeatureCard({
  ...
  title: string;
  description: string;
  icon: React.ReactNode; // better to use ReactNode for icons
}) {
  return (
