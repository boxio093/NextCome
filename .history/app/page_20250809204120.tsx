  ...
  return (
    <section className="flex flex-col-reverse lg:flex-row items-center gap-12 max-w-6xl mx-auto">
      ...
      >
        <motion.h1
          variants={child}
          className="text-5xl font-bold mb-6 leading-tight text-amber-300"
        >
          Welcome to <span className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 bg-clip-text text-transparent">MyApp</span>
        </motion.h1>

        <motion.p
          variants={child}
          className="text-xl text-gray-700 mb-8 dark:text-gray-300"
        >
